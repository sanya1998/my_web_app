...
from app.dependencies.services import ImportServiceAnn
...
async def import_for_admin(background_tasks: BackgroundTasks, file: UploadFile, import_service: ImportServiceAnn):
    try:
