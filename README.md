...
60) Написать свой filters, использовать как свою либу.
...
64) добавить тесты на все эндпоинты
...
66) обновление бронирования не должно иметь значений дат по умолчанию, их можно в подсказки засунуть, но не более, цена наверно тоже
